...
mc_train_dir = BASIC_DIR + 'ising-data-train-%d/L=%d/q=%d/configs.npy'
mc_test_dir = BASIC_DIR + 'ising-data-train-%d/L=%d/q=%d/configs.npy'
mc_critical_train_dir = BASIC_DIR + 'ising-critical-train-%d/L=%d/configs.npy'
mc_critical_test_dir = BASIC_DIR + 'ising-critical-test-%d/L=%d/configs.npy'
